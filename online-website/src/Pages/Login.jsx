...
const Login = () => {
  ...
  const { token, setToken, navigate, backEndUrl } = useContext(ShopContaxt);
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-centerw-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800' action="">
      ...
      <input type="email"  onChange={(e)=>setEmail(e.target.value)} value={email}  className='w-full px-3 py-2 border border-gray-800' placeholder='E-mail' required/>
